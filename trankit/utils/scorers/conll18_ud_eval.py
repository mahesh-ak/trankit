...
#   - NUM: using alignmed words, how well does number match 
...
def load_conllu(file):
    ...
    while True:
        ...
        if not line:
            ...
            if sentence_start < len(ud.words) and len(
                    [word for word in ud.words[sentence_start:] if word.parent is None]) != 1:
                pass
